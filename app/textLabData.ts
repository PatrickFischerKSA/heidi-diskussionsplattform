...
export const labPassages:LabPassage[]=[
  ...
  ],lenses:['Ergebung und Unabänderlichkeit','Glauben gegen eigenes Erproben','Bild → Geschichte → eigener Wunsch','Aufmerksamkeit, Augen und Atem']},
  ...
  ],lenses:['«unvermerkt» lernen','Steigerung: je mehr, desto lieber','Mitdurchleben und Nähe','Lesefreude gegen bleibenden Kummer']},
